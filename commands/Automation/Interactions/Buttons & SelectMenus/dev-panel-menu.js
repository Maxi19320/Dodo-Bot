...
`
        ...
        type: "interaction",
        prototype: "modal",
        code: `$interactionFollowUp[\`$get[embedcolorinput]\` will now be used as the new embed color!;true]
